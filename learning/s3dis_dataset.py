...
def get_datasets(args, test_seed_offset=0):
    ...
    valid_names = ['hallway_1.h5', 'hallway_6.h5', 'hallway_11.h5', 'office_1.h5',
                   'office_6.h5', 'office_11.h5', 'office_16.h5', 'office_21.h5',
                   'office_26.h5', 'office_31.h5', 'office_36.h5', 'WC_2.h5',
                   'storage_1.h5', 'storage_5.h5', 'conferenceRoom_2.h5', 'auditorium_1.h5']
...
def get_info(args):
    ...
    return {
        ...
        'classes': 13,
        'inv_class_map': {0: 'ceiling', 1: 'floor', 2: 'wall', 3: 'column',
                          4: 'beam', 5: 'window', 6: 'door', 7: 'table',
                          8: 'chair', 9: 'bookcase', 10: 'sofa', 11: 'board', 12: 'clutter'},
    }
