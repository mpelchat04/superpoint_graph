...
if args.dataset == 's3dis':
    n_labels = 13
    inv_class_map = {0: 'ceiling', 1: 'floor', 2: 'wall', 3: 'column', 4: 'beam', 5: 'window', 6: 'door', 7: 'table', 8: 'chair', 9: 'bookcase',
                     10: 'sofa', 11: 'board', 12: 'clutter'}
    base_name = args.odir + '/cv'
elif args.dataset == 'vkitti':
    n_labels = 13
    inv_class_map = {0: 'Terrain', 1: 'Tree', 2: 'Vegetation', 3: 'Building', 4: 'Road', 5: 'GuardRail', 6: 'TrafficSign', 7: 'TrafficLight',
                     8: 'Pole', 9: 'Misc', 10: 'Truck', 11: 'Car', 12: 'Van'}
    base_name = args.odir + '/cv'
