...
def get_airborne_lidar_info():
    return {
        'classes': 4,
        'inv_class_map': {0: 'other', 1: 'building', 2: 'water', 3: 'ground'},
    }
...
def graph_loader(entry, train, args, db_path, test_seed_offset=0, full_cpu=False):
    ...
    if train and (0 < args.max_ver_train < n_ver):
        ...
        selected_edg, selected_ver = libply_c.random_subgraph(n_ver, edg_source.astype('uint32'), edg_target.astype('uint32'),
